...
<tr>
<td valign="top" width="43"><a href="/Internships/Maintenance/Internedita.asp?which=<%=rstemp("ID")%>"><b>
  <font color="#000080">Edit</font>
  </b></a></td>
<td valign="top" width="50"><a href="/Internships/Maintenance/InternDelete.asp?which=<%=rstemp("ID")%>"><b>
