<%@ Language=VBScript %>
<%if isempty(Request.ServerVariables("HTTP_REMOTE_USER")) then 
...
TheMessage = "Please log in below:"
	...
	Set RSlogin = conn.Execute("Select ID, UserID,Password from Users where "&"UserID ='" & Request.ServerVariables("HTTP_REMOTE_USER") &"'")
	if RSLogin.EOF then
