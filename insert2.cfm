...
<div id="wrapper"> 
    <div id="content">
        ...
        <p>
        	<font color="red">* = <u>Mandatory Fields&nbsp;</u></font>
        </p>
        <cfform name="insertinternship" id="insertinternship" method = "post"    >
            ...
            <fieldset>
                ...
                <p>
                    ...
                    <br />
                    <cfinput type="text" name="Street" message="Please enter the street where the agency is located." validateat="onSubmit" required="no" id="Street" size="50" maxlength="255">
                </p>
                <p>
                    <label for="City">City</label>
                    <br />
                    <cfinput type="text" name="City" message="Please enter the City where the agency is located." validateat="onSubmit" validate="noblanks" required="no" id="City" size="50" maxlength="255">
                </p>
                <p>
                ...
                <p>
                    ...
                    <br />
                    <cfinput type="text" name="Zip" message="Please enter a zipcode where the agency is located." validateat="onSubmit" required="no" id="Zip" size="5" maxlength="10">
                </p>
                <p>
                    <label for="County"><font color ="red">*</font>County<br />
                    </label>
                ...
                <p>
                    ...
                    <br />
                    <cfinput type="text" name="Phone" message="Please enter the phone number for the agency." validateat="onSubmit" required="no" id="Phone" size="12" maxlength="12">
                </p>
                <p>
                    <label for="Email">Email</label>
                    <br />
                    <cfinput type="text" name="Email" message="Please enter the email address for the agency." validateat="onSubmit" required="no" id="Email" size="50" maxlength="50">
                </p>
                <p>
                ...
                <p>
                    ...
                    <cftextarea name="Description" cols="55" rows="4" label="Description" required="no" validateat="OnSubmit" message="Please enter an internship description"  />
                </p>
                <table >
                    <tr>
                        <td><p>Adolescents:
